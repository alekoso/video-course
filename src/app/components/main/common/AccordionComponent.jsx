                ...
                <Tab
                  ...
                  title={
                    <div>
                      ...
                      {free && (
                        <mark className="absolute top-[-70%] md:top-[-100%] -translate-y-1/2 right-[-15%] md:right-[-10%] rounded-[18419.209px] bg-textColorWhite shadow-[0_2px_4px_rgba(0, 0, 0, 0.25)_inset] border border-[#7375ff] py-1 px-2 l:py-[6px] l:px-[14.5px]">
